...
function LoginPage() {
  ...
  return (
    <>
      <div className="w-full h-20 flex items-center justify-center bg-blue-900 text-white font-bold text-2xl sm:text-3xl font-[Poppins] shadow-md">
        InnSync – India's First Multiple Hotel Management Software
      </div>
      <div className="flex h-screen font-[Poppins]">
        <div className="w-4/5 bg-white flex flex-col justify-center items-center shadow-2xl px-12 py-8">
        ...
        <div className="w-3/5 bg-gradient-to-br from-indigo-600 to-purple-800 text-white flex flex-col justify-center items-start px-20 py-16  shadow-xl">
